...
**Основной поток.**
1. Приложение получает название фильма;
2. Приложение получает информацию с сайта imdb.com. Если отстутствует подключение к интернету, выполняется поток ошибки Е1. Если отстутствует информацию о фильме, выполняется поток ошибки Е2;
...
**Предусловия.** Зарегистрированный пользователь выделил название фильма в списке и нажал на кнопку "Remove".  
**Основной поток.**
