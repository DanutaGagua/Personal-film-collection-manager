...
|003-4-1: Переход к следующему треку, если он последний в списке и кнопка повтора нажата| Нажать на кнопку "Вперёд" | Играет первый трек | Нет возможности запустить плейлист |Тест не пройден|
...
|009-2: Интуитивно понятный и простой интерфейс | Запустить приложение | Элементы понятный пользователю | Тест пройден |
