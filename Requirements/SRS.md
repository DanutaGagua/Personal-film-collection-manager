...
Приложение предоставляет возможность просмотра личной коллекции фильмов только активного пользователя.

<a name="access_requirements"/>

#### 3.2.1.3 Требования к доступности
1. Приложение предоставляет зарегистрированному пользователю возможность просмотра данных о фильме.
2. Приложение предоставляет зарегистрированному пользователю возможность удаления фильма из списка личной коллекции.
3. Приложение предоставляет зарегистрированному пользователю возможность добавления фильма в список личной коллекции при подключении к сети Интернет.
4. Приложение предоставляет возможность поиска информации о фильме при подключении к сети Интернет.
